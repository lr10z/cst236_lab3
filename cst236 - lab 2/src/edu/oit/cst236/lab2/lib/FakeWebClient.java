...
public class FakeWebClient implements IWebClient {
	...
	public FakeWebClient() throws ConnectionException, InvalidLibraryException, InvalidBookException {
	...
	@Override
	public String query(String url) throws InvalidRequestException, ConnectionException, JSONException, InvalidLibraryException, InvalidBookException {
		query();
	...
	private String getLibraries() throws JSONException, InvalidLibraryException {
	...
	private String getLibrary(String libraryId) throws JSONException, InvalidLibraryException {
		JSONObject jsonLibrary = new JSONObject();
	...
	private String getLibraryBooks(String libraryId) throws InvalidLibraryException, JSONException, InvalidBookException {
	...
	private String getLibraryBook(String bookId) throws JSONException, InvalidBookException {
		JSONObject bookJson = new JSONObject();
